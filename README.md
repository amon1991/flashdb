...
![10c2744d23f926e1846620d1bd1eb745.png](en-resource://database/1997:1)
...
#### 3.1 界面概览
![0d50bfd80828e365abe8a904533fa643.png](en-resource://database/1987:1)
上图是FlashTsDB的主界面
* 在页面左上方可查询当前数据库中的测点列表（支持模糊查询）
* 在页面右上方可新建测点
* 对于每个测点，可查询详情
![4564f97b1f8bead79de57f0b7b9af5e6.png](en-resource://database/1989:1)
上图为新建测点界面，其中可通过设置accuracy（精确度）设置压缩时旋转门的大小


#### 3.2 查询测点实时/历史数据
![10e1b8fc76e798ba28f0122764a26c10.png](en-resource://database/1991:1)

* 在上图中，可查询测点的实时数据和历史数据
* 历史数据查询支持查询实际数据和插值数据

#### 3.3 Restful API
![87070dff99aaa02f2e4e952b945b2541.png](en-resource://database/1993:1)
...
![021157a4b25d8a89bf6f0fc4ff479b55.png](en-resource://database/1995:1)
