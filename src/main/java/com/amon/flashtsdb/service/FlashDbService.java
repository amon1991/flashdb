...
public class FlashDbService {
    ...
    @Autowired
    public FlashDbService(HBaseUtil hBaseUtil, RowKeyUtil rowKeyUtil, SdtService sdtService) {
     ...
     * @return
     */
    public int dump2Hbase(List<SplitTagPointList> dataList) {
